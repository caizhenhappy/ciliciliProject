...
<template>
 ...
 <MenuCategoryuList v-if='showFlag'
                         :todayMenuCategoryLists='NameList'
                         :nowTitle='nowTitle'
                         @allSelect='allSelect'
                         :showAll='showAll'
                         />
...
import {getTodayMenuCategoryList} from '../../../api/index'
...
{Object} easing 缓动函数，一般不建议修改，如果想修改，参考源码中的 ease.js 里的写法 */
    ...
    allSelect(index){
      ...
      //console.log(todayMenuCategory.data)
      this.NameList=todayMenuCategory.data.list
        this.$nextTick(() => {
